...
RSpec.describe 'ユーザー新規登録', type: :system do
  ...
  context 'ユーザー新規登録ができるとき' do 
    it '正しい情報を入力すればユーザー新規登録ができてトップページに移動する' do
      ...
      select '20歳未満', from: 'user[age_id]'
      select '男性', from: 'user[gender_id]'
      select '北海道', from: 'user[prefecture_id]'
      select '会社員', from: 'user[profession_id]'
  ...
  context 'ユーザー新規登録ができないとき' do
    it '誤った情報ではユーザー新規登録ができずに新規登録ページへ戻ってくる' do
      ...
      select '選択してください', from: 'user[age_id]'
      select '選択してください', from: 'user[gender_id]'
      select '選択してください', from: 'user[prefecture_id]'
      select '選択してください', from: 'user[profession_id]'
